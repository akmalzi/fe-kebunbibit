...
function LoginForm(){
    return(
        <>
            ...
            <button type="submit" className="text-white bg-primaryColor hover:bg-primaryColor focus:ring-4 focus:outline-none font-medium rounded-sm text-sm w-full px-5 py-2.5 text-center dark:bg-primaryColor dark:hover:bg-primaryColor dark:focus:ring-primaryColor mb-6">Masuk</button>
            <button type="submit" className="text-black bg-white focus:ring-4 focus:outline-none font-medium rounded-sm text-sm w-full px-5 py-2.5 text-center dark:bg-white dark:focus:ring-white border-2 border-black flex items-center justify-center mb-6">
            ...
            <div className="flex justify-center">
                Belum punya akun? <Link className="ml-2 text-blue-700">Daftar Sekarang.</Link>
            </div>
            </htmlForm>
        </>
    )
