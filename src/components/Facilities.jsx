        ...
        <>
            <section className="px-[72px] flex ">
                ...
                <div className="w-1/2 min-h-4 flex">
                    <div className="hover:-translate-y-1 hover:scale-95 transition ease-in-out  w-1/2 h-full mr-4 bg-[url('./assets/fasilitas/mini-zoo.png')] bg-cover bg-center rounded-[10px] p-[30px]">
                        <h3 className="font-bold text-white text-5xl drop-shadow-text">
                            Mini Zoo
                        </h3>
                    </div>
